...
import com.mirvinstalk.app.ui.fragment.GetCoinFragment;
import com.mirvinstalk.app.ui.fragment.SearchBarFragment;
import com.mirvinstalk.app.ui.fragment.SearchFragment;
import com.mirvinstalk.app.ui.fragment.SpendCoinFragment;
...
public class MainActivity extends BaseActivity implements BillingProcessor.IBillingHandler, SearchBarFragment.SearchBarListener, SpendCoinFragment.SpendCoinListener, GetCoinFragment.GetCoinListener {
        ...
        call.enqueue(new Callback<BaseResponse<StalkAmountResponse>>() {
            ...
            public void onResponse(Call<BaseResponse<StalkAmountResponse>> call, Response<BaseResponse<StalkAmountResponse>> response) {
                if (response.isSuccessful()){
                    ...
                    amount = response.body().getData().getStalkAmount();
    ...
    public void getActivePurchases() {
        ...
        loginByCookieRequest.setCookie(SharedPrefsHelper.getInstance().get(SharedPrefsConstant.COOKIE_CODE, ""));
        loginByCookieRequest.setUserCode(SharedPrefsHelper.getInstance().get(SharedPrefsConstant.USER_CODE, ""));
        Call<BaseResponse<ActivePurchasesResponse>> call = instaInsightService.getActivePurchases(loginByCookieRequest);
        call.enqueue(new Callback<BaseResponse<ActivePurchasesResponse>>() {
            @Override
            public void onResponse(Call<BaseResponse<ActivePurchasesResponse>> call, Response<BaseResponse<ActivePurchasesResponse>> response) {
                if (response.isSuccessful()){
                    if(response.body().isSuccess()){
                        iiInvoices = response.body().getData().getIIUser().getIIInvoices();
                        BusStation.getBus().post("IIInvoices");
            ...
            @Override
            public void onFailure(Call<BaseResponse<ActivePurchasesResponse>> call, Throwable t) {
            ...
            public void onResponse(Call<BaseResponse<RegisterResponse>> call, Response<BaseResponse<RegisterResponse>> response) {
                if (response.isSuccessful()) {
                    if (response.body().isSuccess()) {
                        ...
                        SharedPrefsHelper.getInstance().save(SharedPrefsConstant.TRY_FOR_FREE_USERNAME, response.body().getData().getTryForFreeUsername());
                        SharedPrefsHelper.getInstance().saveArrayList(SharedPrefsConstant.PRICE_IN_TRY, response.body().getData().getPricesInTRY());
                        SharedPrefsHelper.getInstance().saveArrayList(SharedPrefsConstant.PRICE_IN_USD, response.body().getData().getPricesInUSD());
                        SharedPrefsHelper.getInstance().saveArrayList(SharedPrefsConstant.PRICE_IN_EUR, response.body().getData().getPricesInEUR());
            ...
            public void onResponse(Call<BaseResponse<RegisterResponse>> call, Response<BaseResponse<RegisterResponse>> response) {
                if (response.isSuccessful()) {
                    if (response.body().isSuccess()) {
                        ...
                        if(response.body().getExceptionMessage().equalsIgnoreCase("01-AuthenticationException")){
                            SharedPrefsHelper.getInstance().save(SharedPrefsConstant.COOKIE_CODE, null);
                            SharedPrefsHelper.getInstance().save(SharedPrefsConstant.USER_CODE, null);
                            logIn();
                        }
                    }
                }
    ...
    public void endDemo() {
        UserProfileActivity.newIntent(this, SharedPrefsHelper.getInstance().get(SharedPrefsConstant.TRY_FOR_FREE_USERNAME,""));
