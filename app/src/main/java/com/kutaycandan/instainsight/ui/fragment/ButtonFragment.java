...
public class ButtonFragment extends Fragment {
    ...
    @OnClick({R.id.ll_hd_profile_picture, R.id.ll_non_followers, R.id.ll_top_likers, R.id.ll_most_active_followers, R.id.ll_latest_popular_post, R.id.ll_non_following, R.id.ll_popular_followers, R.id.ll_like_trend, R.id.ll_stalk_count})
